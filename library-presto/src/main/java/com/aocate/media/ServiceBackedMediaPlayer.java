...
//			new Intent(INTENT_NAME);
		this.playMediaServiceIntent = new Intent(context, SoundService.class);
...
//				ServiceBackedMediaPlayer.this.error(MediaPlayer.MEDIA_ERROR_UNKNOWN, 0);
	...
	public void release() {
		try {
			...
			//TODO IllegalArgumentException --> mContext.unbindService(this.mPlayMediaServiceConnection);
		}
	}
